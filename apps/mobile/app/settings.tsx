...
export default function SettingsScreen() {
  ...
  return (
    ...
    >
      ...
      <Surface style={styles.accountRow}>
        <View style={styles.grow}>
          <Text style={styles.title}>@{viewer?.name ?? ""}</Text>
        </View>
        <Pressable accessibilityLabel="Sign out" accessibilityRole="button" onPress={signOut} style={styles.signOutButton}>
          <Ionicons color={colors.coral} name="log-out-outline" size={21} />
...
const styles = StyleSheet.create({
  ...
  accountRow: { alignItems: "center", flexDirection: "row", gap: spacing.md, minHeight: 64, padding: spacing.md },
  signOutButton: { alignItems: "center", flexDirection: "row", gap: spacing.xs, minHeight: 44, paddingHorizontal: spacing.sm },
  signOutText: { color: colors.coral, fontSize: 14, fontWeight: "700" },
});
